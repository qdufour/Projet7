...
def main():
    ...
    score = st.session_state.scores[example_idx]
    ...
    fig = px.scatter(df, x=selected_feature_1, y=selected_feature_2, color=st.session_state.scores,
                    title="Analyse Bivariée", color_continuous_scale=colorscale)
